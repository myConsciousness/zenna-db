...
/**
 * The class that manages test case of {@link ContentPropertyKey} .
 *
 * @author Kato Shinya
 * @since 1.0.0
 */
public final class ContentPropertyKeyTest {
    ...
    private static final Map<Integer, String> EXPECTED_DEFINITION = new HashMap<>() {
         ...
         */
        private static final long serialVersionUID = 3744512347754998660L;

        {
            put(0, "contentPackage");
            put(1, "mapperSuffix");
        }
    };
