 ...
 * @since 1.0.0
 */
public final class ResultTypeNotFoundException extends RuntimeException {
    ...
    /**
     * Constructs an <code>ResultTypeNotFoundException</code> with no detail
     * message.
     */
    public ResultTypeNotFoundException() {
        super();
    }

    /**
     * Constructs an <code>ResultTypeNotFoundException</code> with the specified
     * detail message.
     *
     * @param s the detail message.
     */
    public ResultTypeNotFoundException(String s) {
        super(s);
    }
     ...
     *                unknown.)
     */
    public ResultTypeNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public ResultTypeNotFoundException(Throwable cause) {
        super(cause);
    }
}
