...
/**
 * Thrown to indicate that an error has occurred when the property file is not
 * found.
 *
 * @author Kato Shinya
 * @since 1.0.1
...
public final class PropertyNotFoundException extends RuntimeException {
    ...
    /**
     * Constructs an <code>PropertyNotFoundException</code> with no detail message.
     */
    ...
    /**
     * Constructs an <code>PropertyNotFoundException</code> with the specified
     * detail message.
     *
